...
>![50sports](../assets/images/50sports.png)
...
* le cumul du nombre d'activités pour le mois en cours.
* le cumul de la durée des efforts de le mois en cours.
...
1. les sports configurés sont les sports pour lesquels vous voulez le detail des activités. Pour chaque sport coché, vous aurez le nombre de séances, le temps d'effort et le dénivelé par jour, semaine, par mois, et par an.
Vous avez la possibilité de choisir la granularité des activités suivies, a la journée, a la semaine, au mois ou a l'année.
...
* Cumul du nombre d'activités pour le mois en cours.
* Cumul de la durée des efforts de le mois en cours.
